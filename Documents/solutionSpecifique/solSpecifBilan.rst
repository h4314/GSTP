...
la gestion de projet. Cependant, ces outils sont généralement complétement
...
applicatifs développés spécifiquements. L'interface utilisateur de cette
...
La gestion de l'information chez GSTP est formalisée et rationnalisée d'une
part, tout en conservant les processus les plus efficaces déjà adoptés par
l'entreprise d'autre part. Les opérationnels de l'enteprise seront formés aux
